                            ...
                            <fieldset>
                                <table>
                                    ...
                                    <tr><td align="center"><?php
                                            ...
                                            $col=$_SESSION["col"];
                                            $_SESSION["id"]=$id;
                                            $sql1="SELECT $col FROM $teb WHERE No=$id";
                                            ...
                                            echo '<textarea rows="8" name="data" cols="29" style="background-color: #eeeeee" placeholder="add the new data"></textarea>';
                                            }
                                            }

                                            ?></td></tr>
                                    <tr><td align="center"><input style="width: 25mm;height: 9mm;font-size: 20px;background-color: #d0d0d0;" type="submit" value="Update" name="submit" formmethod="post" formaction="upp.php"></td></tr>
                            </fieldset>
                        </form>
            </table></td></tr>   </table>
<hr/>
...
if(isset($_POST['submit'])){
    $sql="UPDATE $teb SET $col value (".$_POST['data'].")WHERE No=$id";
