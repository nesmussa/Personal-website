...
<table width="1050" align="center"><tr><td>
            ...
            <table align="center"><tr><td>
                        <form>
                            <fieldset>
                                <table>
                                    <legend>Change User Name or Password</legend>
                                    <tr><td><input type="text"  style="width: 50mm;height: 7mm;font-size: 20px;background-color: #eae9e9;" name="data" placeholder="New Uname or Pass"></td></tr>
                                    <tr><td><select style="width: 50mm;font-size: 20px; height: 7mm;" name="into">
                                                <option value="uname">Username</option>
                                                <option value="pass">Password</option>
                                            </select> </td></tr>
                                    <tr><td align="center"><input style="width: 25mm;height: 9mm;font-size: 20px;background-color: #d0d0d0;" type="submit" value="Change" name="submit" formmethod="post" formaction="chpss.php"></td></tr>
                            </fieldset>
                        </form>
            </table></td></tr>   </table>
            <hr/>
