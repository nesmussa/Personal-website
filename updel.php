                        ...
                        <form>
                            <fieldset>
                                <table>
                                    ...
                                    <tr><td align="center"><input style="width: 25mm;height: 9mm;font-size: 20px;background-color: #d0d0d0;" type="submit" value="Choose" name="submit" formmethod="post" formaction="listtoup.php"></td></tr>
                            </fieldset>
                        </form>
            </table></td></tr>   </table>
<hr/>
